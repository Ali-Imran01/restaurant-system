...
<div class="flex bg-slate-50 min-h-screen pl-64">
    ...
    <div class="flex-1 p-10">
        <header class="flex justify-between items-center mb-12">
            <div>
                <h1 class="text-4xl font-black text-slate-900 tracking-tight">Platform Team</h1>
                <p class="text-slate-500 font-medium mt-1">Manage users with master administrative access.</p>
            </div>
        </header>
