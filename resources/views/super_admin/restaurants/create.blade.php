...
<div class="flex bg-slate-50 min-h-screen pl-64">
    ...
    <div class="flex-1 p-10">
        <header class="mb-12">
            ...
            <h1 class="text-4xl font-black text-slate-900 tracking-tight">Onboard Restaurant</h1>
            <p class="text-slate-500 font-medium mt-1">This will create a new restaurant and a master owner account.</p>
        </header>
