...
<div class="flex h-screen bg-slate-50 overflow-hidden font-sans">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-8 shrink-0">
            <div>
                <h1 class="text-2xl font-black text-slate-900 tracking-tight">Tables & QR Codes</h1>
                <p class="text-slate-500 text-xs font-bold uppercase tracking-widest mt-1">Management of Physical Infrastructure</p>
            </div>
            <div class="flex items-center space-x-4">
                <a href="{{ route('tables.create') }}" class="bg-primary-500 text-white px-6 py-3 rounded-2xl font-black text-sm hover:bg-primary-600 shadow-lg shadow-primary-500/20 transition-all flex items-center">
